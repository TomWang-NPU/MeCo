...
# fixed_positions = {
#             "red_cube": np.array([1.1285935 , 0.56156855]),
#             "blue_cube": np.array([0.23209099, 0.51066136]),
#             "green_cube": np.array([0.59441773, 0.517273]),
#         }
...
class SweepTask(MujocoSimEnv):
    ...
    def sample_initial_scene(self):
        ...
        for _idx, cube_name in zip(panel_idxs, self.cube_names):
            ...
            # if cube_name in fixed_positions:
            #     new_pos = np.array([fixed_positions[cube_name][0], fixed_positions[cube_name][1],self.physics.data.body(cube_name).xpos[2]])
